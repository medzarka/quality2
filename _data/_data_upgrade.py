...
class upgrade(models.Model):
    ...
    original_filename_path = models.CharField(max_length=2500, verbose_name='Original Filename Path', default='')
    temporary_filename_path = models.CharField(max_length=2500, verbose_name='Temporary Filename Path', default='')
    temporary_filename = models.CharField(max_length=250, verbose_name='Temporary Filename', default='')
    status = models.CharField(max_length=1, choices=PROGRESS, default='I')
    description = models.CharField(max_length=2500, verbose_name='Progress Description')
