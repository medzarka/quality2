...
class upgrade(models.Model):
    ...
    original_filename_path = models.CharField(max_length=250, verbose_name='Original Filename Path', default='')
    temporary_filename_path = models.CharField(max_length=250, verbose_name='Temporary Filename Path', default='')
