...
class _dashboard(Abstract_UI_Page):
    ...
    def CreateBlocks(self, _blocks_list=None):
        ...
        for _meeting in _my_meetings:
            ...
            _text1 = ui_text_element(text=f'{_meeting.department.department_name}', color=UI_TEXT_COLOR_Enum.TEXT_DARK)
            _cell1 = table_cell(cell_centent=_text1)
            _row.add_cell_to_row(_cell1)

            _text1 = ui_text_element(text=f'{_meeting.campus.campus_name}', color=UI_TEXT_COLOR_Enum.TEXT_DARK)
            _cell1 = table_cell(cell_centent=_text1)
            _row.add_cell_to_row(_cell1)
